...
|--------------|-------------------------|-------------------------|-----------------|---------------------|--------------------|
|Voluntário 1  |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|2min 05seg.|4 |2 |
|Voluntário 2  |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 48seg.|4 |1 |
|Voluntário 3  |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|2min 53seg.|2 |2 |
|Voluntário 4  |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 40seg.|4 |1 |
|Voluntário 5  |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 32seg.|4 |1 |
