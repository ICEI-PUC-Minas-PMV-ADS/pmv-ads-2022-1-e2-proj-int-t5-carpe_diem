...
|IDENTIFICAÇÃO |TESTE                    |O QUE FOI AVALIADO       |TEMPO GASTO      |NÍVEL DE DIFICULDADE |NÍVEL DE SATISFAÇÃO |
|--------------|-------------------------|-------------------------|-----------------|---------------------|--------------------|
|Voluntário 01 |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|2min 05seg.|4 |2 |
...
|Voluntário 02 |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 48seg.|4 |1 |
|Voluntário 03 |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|2min 53seg.|2 |2 |
|Voluntário 03 |Logar no Sistema         |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 10seg.|4 |1 |
|Voluntário 04 |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 40seg.|4 |1 |
...
|Voluntário 05 |Cadastro de novo usuário |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 32seg.|4 |1 |
|Voluntário 06 |Logar no Sistema         |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|34seg.     |4 |1 |
...
|Voluntário 07 |Logar no Sistema         |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 20seg.|4 |1 |
|Voluntário 08 |Logar no Sistema         |Concretização da tarefa. Quantidade e tipo de erros cometidos. Tempo necessário para se concluir.|1min 05seg.|4 |1 |
